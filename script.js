...
showSolutionButtons.forEach(btn => {
    btn.addEventListener('click', function (){
        const hdnCntnt = btn.nextElementSibling;
        hdnCntnt.classList.toggle('show');
    });
});
...
// Sample lessons
const lessons = [
    { name: "Introduction to Integral Calculus", url: "intro.html" },
    { name: "Basic Integrals", url: "BasicInt.html" },
    { name: "Substitution", url: "sub.html" },
    { name: "Integration by Parts", url: "IntByPart.html" },
    { name: "Definite Integrals", url: "DefInt.html" },
    { name: "Applications", url: "App.html" }
];

// Function to filter lessons and display results
function searchLessons(query) {
    // Filter lessons based on the query
